#
# Be sure to run `pod lib lint chinmayframework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of chinmayframework.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'chinmayframework/Classes/**/*'
  
  # s.resource_bundles = {
  #   'chinmayframework' => ['chinmayframework/Assets/*.png']
  # }
